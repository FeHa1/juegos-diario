...
TWEEN.Group = _Group, TWEEN._nextId = 0, TWEEN.nextId = function() {
    ...
    update: function(t) {
      ...
      for (n in !1 === this._onStartCallbackFired && (null !== this._onStartCallback && this._onStartCallback(this._object), this._onStartCallbackFired = !0), e = (t - this._startTime) / this._duration, e = 0 === this._duration || 1 < e ? 1 : e, i = this._easingFunction(e), this._valuesEnd) void 0 !== this._valuesStart[n] && (r = this._valuesStart[n] || 0, (a = this._valuesEnd[n]) instanceof Array ? this._object[n] = this._interpolationFunction(a, i) : "number" == typeof(a = "string" == typeof a ? "+" === a.charAt(0) || "-" === a.charAt(0) ? r + parseFloat(a) : parseFloat(a) : a) && (this._object[n] = r + (a - r) * i));
    ...
    CatmullRom: function(t, n) {
      ...
      return t[0] === t[e] ? a(t[((r = n < 0 ? Math.floor(i = e * (1 + n)) : r) - 1 + e) % e], t[r], t[(r + 1) % e], t[(r + 2) % e], i - r) : n < 0 ? t[0] - (a(t[0], t[0], t[1], t[1], -i) - t[0]) : 1 < n ? t[e] - (a(t[e], t[e], t[e - 1], t[e - 1], i - e) - t[e]) : a(t[r ? r - 1 : 0], t[r], t[e < r + 1 ? e : r + 1], t[e < r + 2 ? e : r + 2], i - r)
    },
    Utils: {
      ...
      CatmullRom: function(t, n, e, i, r) {
        var a = .5 * (e - t),
          t = .5 * (i - n),
          i = r * r;
        return (2 * n - 2 * e + a + t) * (r * i) + (-3 * n + 3 * e - 2 * a - t) * i + a * r + n
      }
    }
  },
  function(t) {
