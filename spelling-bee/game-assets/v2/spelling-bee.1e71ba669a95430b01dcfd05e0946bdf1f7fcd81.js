! function(e, t) {
  ...
  var ce = function e(t, n) {
      for (var r = ne(t), o = r.length; o;) {
        ...
        var a = Math.floor(Math.random() * o),
          i = r[o];
        if (r[o] = r[a], r[a] = i, n && (t[o] === r[o] || t[a] === r[a])) return e(t, !0)
      }
      return r
    },
    le = function(t) {
  ...
  var pt = {
    ...
    bt = function(e) {
      ...
      if (!t || !t.navigationLinks || !t.navigationLinks.subscribe) return yt;
  ...
  var $n, Un, Hn, Fn, Vn, qn, Ct = window.location.origin,
    Ct = ($n = {
    ...
    e = (Un = [{
      ...
      return e = o, (t = [{
        ...
        value: function(e, t) {
          var n = this;
          if (Fn.includes(e) && Fn.includes(t)) return function(t, n, e) {
  ...
  function Qn(o) {
    return function(r) {
      return function(e) {
        ...
        if (e.type === L) {
          e = o.getState();
          if (Lt(e).hasXwd && !n) switch (tr.getCurrentMoment()) {
            case "cutoff":
  ...
  }), e.addEventListener("testPassiveEventSupport", no = function() {}, ma), e.removeEventListener("testPassiveEventSupport", no, ma), wr = fr);
  ...
  var Sr = {
    ...
    _r = function(e) {
      var t = e.activeKey,
        ...
        c = m.useRef(null);
      return m.useEffect(function() {
        if (c.current) return Er(c.current, i, a)
      }, []), h.createElement("svg", {
...
//# sourceMappingURL=spelling-bee.1e71ba669a95430b01dcfd05e0946bdf1f7fcd81.js.map
